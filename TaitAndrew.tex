...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in .jcall("{}RJavaTools"{}, "{}Z"{}, "{}hasField"{}, .jcast(x, "{}java/lang/Object"{}), : java.lang.NullPointerException}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in sprintf("{}Predicted: \%s"{}, predictions): object 'predictions' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in is.factor(x): object 'predictions' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in confusionMatrix(predictions, sample\$class): object 'predictions' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in cat("{}Accuracy is: "{}, confusion.mstream\$overall["{}Accuracy"{}]): object 'confusion.mstream' not found}}\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{buildCorpus} \hlkwb{<-} \hlkwa{function} \hlstd{(}\hlkwc{tweets}\hlstd{,} \hlkwc{wordCloud}\hlstd{,} \hlkwc{wholeDataSet}\hlstd{,} \hlkwc{wordAssocation}\hlstd{)\{}
...
\hlstd{\}}
  ...
  \hlcom{#If wordAssocation is true then create document term matrix}
  \hlkwa{if}\hlstd{(wordA)\{}
    \hlkwa{if}\hlstd{(wordAssocation)\{}
      \hlstd{dtm} \hlkwb{<-} \hlkwd{DocumentTermMatrix}\hlstd{(corp)}
    \hlstd{\}}
  \hlstd{\}}\hlkwa{else if}\hlstd{(}\hlopt{!}\hlstd{wordA)\{} \hlcom{# If no  wordAssocation then create TermDocument Matrix}
